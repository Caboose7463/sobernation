...
export const PRIVATE_REHAB_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Private rehab in [location] offers immediate access to residential treatment for alcohol and drug addiction, typically without NHS waiting lists. Private rehab programmes in and around [location] usually last 28, 60, or 90 days and include medically supervised detox, individual and group therapy, CBT, and structured aftercare planning. Costs range from Â£3,000 to Â£15,000+ for 28 days depending on the facility.',
  keyFacts: [
    { label: 'Typical cost', value: 'Â£3,000â€“Â£15,000 for 28 days', icon: 'ðŸ’·' },
  ...
  faqs: (location: string) => [
    { question: `How much does private rehab in ${location} cost?`, answer: `Private rehab near ${location} typically costs Â£3,000â€“Â£8,000 for a standard 28-day residential programme. Premium facilities can cost Â£10,000â€“Â£15,000 or more. Day treatment (attending rehab without staying overnight) is less expensive â€” typically Â£1,000â€“Â£3,000. Many private rehabs offer payment plans, and some accept NHS-funded referrals.` },
...
export const REHAB_COST_CONFIG: RehabTypeConfig = {
  ...
  intro: 'The cost of rehab in [location] depends on whether you choose private treatment or access free NHS treatment. NHS rehab is completely free. Private residential rehab in and around [location] typically costs Â£3,000â€“Â£8,000 for a standard 28-day programme, rising to Â£15,000+ for premium facilities. Day programmes and community treatment are less expensive alternatives.',
  keyFacts: [
    { label: 'NHS treatment', value: 'Free â€” community and residential options', icon: 'ðŸ’™' },
    { label: 'Private 28-day', value: 'Â£3,000â€“Â£8,000 (standard)', icon: 'ðŸ’·' },
    { label: 'Premium 28-day', value: 'Â£10,000â€“Â£20,000+', icon: 'ðŸ†' },
    { label: 'Day programme', value: 'Â£1,500â€“Â£4,000 for a full programme', icon: 'ðŸ˜ï¸' },
  ],
  bodyParagraphs: [
    ...
    'For those who choose private treatment, costs vary significantly depending on the type of facility, programme length, and location. Standard UK private rehab costs Â£3,000â€“Â£8,000 for 28 days. Luxury facilities â€” often set in country houses or rural retreats â€” can cost Â£15,000â€“Â£25,000. However, there is no direct correlation between cost and treatment quality or outcomes.',
...
export const SOBER_LIVING_CONFIG: RehabTypeConfig = {
  ...
  keyFacts: [
    ...
    { label: 'Average cost', value: 'Â£100â€“Â£300/week (some funded by council)', icon: 'ðŸ’·' },
