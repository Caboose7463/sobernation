...
export const PRIVATE_REHAB_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Private rehab in [location] offers immediate access to residential treatment for alcohol and drug addiction, typically without NHS waiting lists. Private rehab programmes in and around [location] usually last 28, 60, or 90 days and include medically supervised detox, individual and group therapy, CBT, and structured aftercare planning. Costs range from £3,000 to £15,000+ for 28 days depending on the facility.',
  keyFacts: [
    { label: 'Typical cost', value: '£3,000–£15,000 for 28 days', icon: '💷' },
    { label: 'Wait time', value: 'Often same-week admission', icon: '⚡' },
    { label: 'What\'s included', value: 'Detox, therapy, meals, accommodation, aftercare', icon: '🏥' },
    { label: 'NHS-funded places', value: 'Available in some cases — ask your GP', icon: '💙' },
  ],
  bodyParagraphs: [
    ...
    'For those who cannot afford private rehab, NHS-funded residential places are sometimes available — speak to your GP or local drug and alcohol service. Some charities also offer funded or subsidised residential treatment places. The free Frank helpline (0300 123 6600) can advise on all options.',
  ],
  faqs: (location: string) => [
    { question: `How much does private rehab in ${location} cost?`, answer: `Private rehab near ${location} typically costs £3,000–£8,000 for a standard 28-day residential programme. Premium facilities can cost £10,000–£15,000 or more. Day treatment (attending rehab without staying overnight) is less expensive — typically £1,000–£3,000. Many private rehabs offer payment plans, and some accept NHS-funded referrals.` },
    ...
    { question: `How quickly can I get into private rehab near ${location}?`, answer: `Many private rehab centres can arrange admission within 24–72 hours of enquiry, and some offer same-day admission for emergency cases. This speed of access is one of the key advantages of private treatment compared to NHS pathways in ${location}, which may have waiting lists of weeks to months.` },
    ...
    { question: `Does private rehab guarantee recovery?`, answer: `No treatment can guarantee recovery, but private residential rehab gives people the best possible start. Research consistently shows that longer treatment episodes (60–90 days) produce better outcomes than shorter programmes. The quality of aftercare planning — including community support, AA/NA attendance, and counselling — is also crucial to long-term recovery.` },
...
export const NHS_REHAB_CONFIG: RehabTypeConfig = {
  ...
  keyFacts: [
    { label: 'Cost', value: 'Free on the NHS', icon: '💙' },
    { label: 'How to access', value: 'GP referral or self-referral via Frank', icon: '📞' },
    { label: 'Community treatment', value: 'Usually available within weeks', icon: '🏘️' },
    { label: 'Residential', value: 'Available for eligible cases', icon: '🏥' },
  ],
  bodyParagraphs: [
    'NHS drug and alcohol services in [location] provide a full range of free treatment — from community outpatient support to medically supervised detox and residential rehabilitation for those who need it most. All NHS treatment is free at the point of use and is completely confidential.',
    ...
    'For people who need residential (live-in) treatment, NHS-funded residential rehab is available for those assessed as requiring this level of support. Funding decisions are made by treatment services — speak to your keyworker or GP about whether residential treatment is appropriate for your situation in [location].',
  ],
  faqs: (location: string) => [
    { question: `Is NHS rehab really free in ${location}?`, answer: `Yes. All NHS drug and alcohol treatment in ${location} is free at the point of use, including community keyworking, medication, psychological therapy, and — for those clinically assessed as needing it — funded residential rehabilitation. There are no charges for NHS treatment.` },
    { question: `How do I access NHS rehab in ${location}?`, answer: `You can access NHS drug and alcohol services in ${location} by: (1) self-referring directly to your local drug service — call Frank on 0300 123 6600 to find the right service; (2) speaking to your GP, who can refer you; or (3) going to A&E if you are in immediate crisis. No appointment is needed to self-refer.` },
    { question: `Is there a waiting list for NHS rehab in ${location}?`, answer: `Community NHS treatment (outpatient keyworking, medication) in ${location} is usually available within a few weeks. NHS-funded residential rehabilitation may have a longer wait, as it depends on assessment, funding approval, and bed availability. If your situation is urgent, tell your keyworker or GP — crisis provisions exist.` },
...
export const REHAB_COST_CONFIG: RehabTypeConfig = {
  ...
  keyFacts: [
    { label: 'NHS treatment', value: 'Free — community and residential options', icon: '💙' },
    { label: 'Private 28-day', value: '£3,000–£8,000 (standard)', icon: '💷' },
    { label: 'Premium 28-day', value: '£10,000–£20,000+', icon: '🏆' },
    { label: 'Day programme', value: '£1,500–£4,000 for a full programme', icon: '🏘️' },
  ],
  bodyParagraphs: [
    'Rehab does not have to cost anything. NHS drug and alcohol services in [location] provide free treatment including community keyworking, medication-assisted detox, CBT, and — for those who need it — funded residential rehabilitation. Call Frank on 0300 123 6600 to access free NHS treatment in [location].',
  ...
  faqs: (location: string) => [
    ...
    { question: `How long does rehab typically last?`, answer: `Residential rehab programmes in ${location} typically run for 28, 60, or 90 days. Research consistently shows that longer programmes (60–90 days) produce significantly better long-term outcomes than shorter ones. Community-based treatment (outpatient) continues for months or years. There is no "right" length — it depends on the severity of the addiction and individual circumstances.` },
  ],
  ctaLabel: 'Call Frank free: 0300 123 6600',
  ctaHref: 'tel:03001236600',
...
export const DUAL_DIAGNOSIS_CONFIG: RehabTypeConfig = {
  ...
  keyFacts: [
    { label: 'What it is', value: 'Mental health + addiction treated together', icon: '🧠' },
    { label: 'NHS access', value: 'Free — via GP or Frank 0300 123 6600', icon: '💙' },
    { label: 'Common conditions', value: 'Depression, anxiety, PTSD, bipolar, psychosis', icon: '💊' },
    { label: 'Private treatment', value: 'Available — specialist dual diagnosis rehabs', icon: '🏥' },
  ],
  bodyParagraphs: [
  ...
  faqs: (location: string) => [
    ...
    { question: `Which comes first — treating the addiction or the mental health?`, answer: `Both should be treated simultaneously in an integrated programme. Treating only the addiction whilst leaving an untreated mental health condition (e.g., undiagnosed PTSD or depression) leads to relapse — the substance was being used to cope. Treating only the mental health without addressing the addiction means the substance continues to undermine progress.` },
    ...
    { question: `Is ADHD linked to addiction?`, answer: `Yes. ADHD is significantly overrepresented in people with substance use problems — research suggests 20–30% of people in addiction treatment have ADHD. Undiagnosed ADHD often leads to self-medication with stimulants, cannabis, or alcohol. A dual diagnosis programme in ${location} can assess for ADHD and provide appropriate treatment.` },
  ],
  ctaLabel: 'Get help — 0300 123 6600',
  ctaHref: 'tel:03001236600',
...
export const SOBER_LIVING_CONFIG: RehabTypeConfig = {
  ...
  keyFacts: [
    { label: 'Who it\'s for', value: 'People leaving rehab or needing stable recovery housing', icon: '🏠' },
    { label: 'Average cost', value: '£100–£300/week (some funded by council)', icon: '💷' },
    { label: 'Typical stay', value: '3–12 months', icon: '📅' },
    { label: 'Requirements', value: 'Abstinence, meetings attendance, house rules', icon: '📋' },
  ],
  bodyParagraphs: [
  ...
  faqs: (location: string) => [
    ...
    { question: `How long do people stay in sober living?`, answer: `The typical stay in a sober living home is 3–12 months, although some people choose to stay longer. The goal is to reach a point where you are stable in recovery, employed or training, and ready to live independently. Studies show the longer someone stays in recovery housing (up to around 12 months), the better their long-term outcome.` },
    { question: `Is sober living better than going home after rehab?`, answer: `For many people, yes. Research consistently shows that people who move to recovery housing after residential rehab have significantly better outcomes than those who return directly to previous environments — particularly if that environment involves people who use drugs or alcohol. If your home environment is a risk to your sobriety, a sober living home in ${location} is worth considering.` },
  ],
  ctaLabel: 'Get support — 0300 123 6600',
  ctaHref: 'tel:03001236600',
  secondaryCta: { label: 'Find rehab in [Location]', href: '/rehab/[location]' },
}
...
export const DETOX_CENTRES_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Detox centres in [location] provide medically supervised withdrawal from alcohol and drugs — the critical first step for people with physical dependency. A medical detox is essential for alcohol, benzodiazepines, and opioids where sudden stopping can be dangerous. Detox centres in and around [location] are available through the NHS (free) and privately (from around £1,500–£5,000 for 7–10 days).',
  keyFacts: [
    { label: 'NHS detox', value: 'Free — community or residential', icon: '💙' },
    { label: 'Private detox', value: 'From ~£1,500 for 7–10 days', icon: '💷' },
    { label: 'Duration', value: 'Typically 5–14 days depending on substance', icon: '📅' },
    { label: 'Who needs it', value: 'Anyone with physical alcohol or drug dependency', icon: '🏥' },
  ],
  bodyParagraphs: [
    ...
    'After completing detox in [location], most people benefit from entering a rehabilitation programme to address the psychological aspects of addiction. Detox alone has high relapse rates — it removes the physical dependency but not the psychological and behavioural patterns that drive addiction.',
  ],
  faqs: (location: string) => [
...
export const HOW_TO_HELP_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Helping someone with an addiction in [location] starts with understanding, not enabling. Whether a family member, partner, or friend is struggling with alcohol or drug addiction, your support can make a life-changing difference — but it needs to be the right kind of support. This guide covers how to have the conversation, where to get professional help in [location], and how to look after yourself too.',
  keyFacts: [
    { label: 'Frank helpline', value: '0300 123 6600 (free, 24/7)', icon: '📞' },
    { label: 'Family support', value: 'Al-Anon, Adfam, GamCare families', icon: '👨‍👩‍👧' },
    { label: 'What helps', value: 'Clear limits, professional guidance, patience', icon: '💛' },
    { label: "What doesn't help", value: 'Enabling, empty ultimatums, giving money', icon: '⚠️' },
  ],
  bodyParagraphs: [
  ...
  faqs: (location: string) => [
    ...
    { question: `What should I not say to someone with an addiction?`, answer: `Avoid: "Just stop," "You're selfish/weak," empty threats, ultimatums without support. Instead say: "I'm worried about you," "I love you and I want to help," "Would you be open to speaking to a doctor?" — approach them when they are sober and relatively calm.` },
    { question: `What is enabling and how do I stop?`, answer: `Enabling means taking actions that allow someone's addiction to continue — giving money you know will be spent on substances, covering up their addiction, making excuses, or bailing them out repeatedly. It feels like helping but removes consequences that might motivate change. Al-Anon meetings in ${location} can help you identify enabling patterns.` },
    { question: `Should I give my addicted family member money?`, answer: `Giving money directly to someone addicted to drugs or alcohol is very likely to fund their addiction. Consider paying bills directly or buying food instead. Many families choose to stop all financial support — this is difficult but can be an important limit. Speak to Al-Anon or Adfam for guidance.` },
    { question: `My loved one refuses to get help — what can I do?`, answer: `You cannot force someone into treatment against their will. What you can do: continue to encourage treatment, model healthy limits, get your own support (Al-Anon, Adfam, counselling), reduce enabling behaviours, and keep the door open. Sometimes people need to reach their own turning point before accepting help.` },
    { question: `Where can I get support as a family member in ${location}?`, answer: `Al-Anon (0800 0086 811) offers meetings for families of people with alcohol problems. Adfam (adfam.org.uk) supports families affected by all drug and alcohol use. GamCare's helpline (0808 8020 133) supports families of gamblers. Frank (0300 123 6600) also provides family guidance. Your own GP can refer you to counselling — you matter too.` },
  ],
...
export const ALCOHOL_REHAB_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Alcohol rehab in [location] provides specialist treatment for alcohol dependency — from free NHS community services to private residential rehabilitation. Alcohol rehab typically includes medically supervised detox (essential for severe dependency), residential therapy, CBT, and structured aftercare. Both free NHS and private alcohol rehab are available in and around [location].',
  keyFacts: [
    { label: 'NHS alcohol rehab', value: 'Free — via GP or Frank 0300 123 6600', icon: '??' },
    { label: 'Private 28-day', value: '£3,000–£10,000 (includes detox)', icon: '??' },
    { label: 'Community detox', value: 'At home with medication — often NHS funded', icon: '???' },
    { label: 'Success rates', value: 'Best outcomes with 60–90 day programmes', icon: '??' },
  ],
  bodyParagraphs: [
    'Alcohol rehab in [location] addresses both the physical and psychological aspects of alcohol dependency. Physical dependency on alcohol requires a medically supervised detox — stopping suddenly without medical support can cause life-threatening seizures. Never stop drinking heavily without speaking to a doctor first.',
  ...
  faqs: (location: string) => [
    ...
    { question: `How long is alcohol rehab in ${location}?`, answer: `NHS community alcohol treatment in ${location} is typically provided over 6–12 months. Residential programmes run for 28, 60, or 90 days. Research shows longer residential programmes produce significantly better long-term sobriety rates.` },
...
export const DRUG_REHAB_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Drug rehab in [location] provides specialist treatment for all types of drug dependency — heroin, cocaine, crack, cannabis, prescription drugs, and more. Free NHS drug rehab is available in [location] through self-referral. Private residential drug rehab typically offers faster access, with admission possible within days. Both approaches can be life-changing.',
  keyFacts: [
    { label: 'NHS drug rehab', value: 'Free — self-refer via Frank 0300 123 6600', icon: '??' },
    { label: 'Private 28-day', value: '£3,000–£10,000 all-inclusive', icon: '??' },
    { label: 'Community treatment', value: 'Keyworking, medication, CBT — free', icon: '???' },
    { label: 'Who it helps', value: 'Heroin, cocaine, crack, cannabis, prescription drugs', icon: '??' },
  ],
  bodyParagraphs: [
    'Drug rehab in [location] is available for all types of substance dependency. NHS community drug treatment — including methadone or buprenorphine prescribing, CBT, keyworking, and group therapy — is free and can be accessed immediately through self-referral. Private residential drug rehab offers an intensive environment away from triggers.',
  ...
  faqs: (location: string) => [
    { question: `How do I get into drug rehab in ${location}?`, answer: `Call Frank on 0300 123 6600 (free, 24/7) to self-refer to NHS drug treatment services in ${location}. You can also speak to your GP. Private drug rehab near ${location} can often arrange admission within 24–72 hours — many operate 24-hour admissions lines.` },
    ...
    { question: `How long is drug rehab?`, answer: `NHS community drug treatment is typically 6–18 months. Residential programmes run 28, 60, or 90 days. Longer residential programmes produce better outcomes. After residential rehab, ongoing aftercare including counselling and NA meetings is essential.` },
    { question: `What is the difference between detox and drug rehab?`, answer: `Detox is the process of safely removing drugs from your body — it is the first and most intense phase. Drug rehab is the longer programme that addresses psychological, behavioural, and social aspects of addiction after detox. Detox alone has very high relapse rates — rehab builds the skills for sustained recovery.` },
    { question: `Can I go to drug rehab while on methadone?`, answer: `Yes. Being on methadone or buprenorphine does not prevent you from accessing drug rehab. Many NHS community treatment programmes include methadone alongside therapy. Some residential rehabs also accept patients on opioid substitution therapy — ask when you enquire.` },
  ],
  ctaLabel: 'Call Frank free: 0300 123 6600',
  ctaHref: 'tel:03001236600',
  secondaryCta: { label: 'Find private rehab in [Location]', href: '/private-rehab/[location]' },
...
export const BINGE_DRINKING_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Binge drinking is defined by the NHS as drinking more than 6 units (women) or 8 units (men) in a single session. It is the most common pattern of harmful alcohol use in the UK — affecting an estimated 8 million adults. Free, confidential help for binge drinking is available in [location] through your GP, NHS alcohol services, and online programmes. You do not need to be physically dependent to access support.',
  keyFacts: [
...
export const NALOXONE_CONFIG: RehabTypeConfig = {
  ...
  keyFacts: [
    ...
    { label: 'Response time', value: 'Works within 2–3 minutes', icon: '?' },
  ],
  bodyParagraphs: [
  ...
  faqs: (location: string) => [
    ...
    { question: `How do I use naloxone?`, answer: `Nasal naloxone (Nyxoid): remove cap, tilt head back, insert nozzle into one nostril, press plunger firmly. Repeat in the other nostril if no response after 2–3 minutes. Injectable: inject into outer thigh. Always call 999 first.` },
    { question: `Does naloxone work on fentanyl?`, answer: `Yes, but higher or repeated doses may be required. Fentanyl is extremely potent, and standard naloxone doses may wear off before the fentanyl does. Administer a second dose if there is no response after 2–3 minutes. Always call 999 regardless.` },
    ...
    { question: `Can naloxone harm someone who hasn't taken opioids?`, answer: `Naloxone has no effect on someone who has not taken opioids — it is a pure opioid antagonist. If someone is unconscious due to alcohol or another non-opioid substance, naloxone will not help them but it will not harm them either. If unsure what someone has taken, it is always safe to give naloxone.` },
    { question: `What happens after someone is given naloxone?`, answer: `After naloxone reverses an overdose, the person may experience sudden withdrawal symptoms (nausea, agitation). Naloxone effects last 30–90 minutes — there is a risk of re-overdose after it wears off. Hospital attendance is essential even when initial reversal appears complete.` },
  ],
  ctaLabel: 'Find naloxone near you — 0300 123 6600',
  ctaHref: 'tel:03001236600',
...
export const CHEMSEX_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Chemsex refers to the use of specific drugs — typically crystal meth, mephedrone, and GHB/GBL — to facilitate or enhance sexual activity, predominantly (but not exclusively) among gay and bisexual men. Specialist chemsex support is available in [location] through NHS sexual health services, drug services, and LGBT+ charities. Care is always non-judgemental and confidential.',
  keyFacts: [
  ...
  faqs: (location: string) => [
    ...
    { question: `Is GHB/GBL dangerous?`, answer: `Yes — GHB and GBL are among the most dangerous chemsex drugs. The margin between a recreational dose and an overdose is extremely small, and effects vary unpredictably between batches. GHB overdose causes sudden loss of consciousness which can rapidly become fatal. Never use GHB alone. If someone becomes unresponsive: call 999 immediately and place in recovery position.` },
...
export const OPIATE_ADDICTION_CONFIG: RehabTypeConfig = {
  ...
  tagline: 'Help for opioid dependency — heroin, methadone, prescription opioids',
  intro: 'Opiate (opioid) addiction covers dependency on heroin, methadone, prescription opioids (codeine, tramadol, oxycodone, fentanyl), and other opioid drugs. Free opiate addiction treatment in [location] is available through NHS drug services — including methadone or buprenorphine prescribing, medically supervised detox, and residential rehab. Call Frank on 0300 123 6600 (free, 24/7) to access opioid treatment in [location] without delay.',
  keyFacts: [
    { label: 'NHS treatment', value: 'Free — methadone, buprenorphine, detox, rehab', icon: '??' },
    { label: 'Key medications', value: 'Methadone, buprenorphine (Subutex/Suboxone)', icon: '??' },
    { label: 'Overdose reversal', value: 'Naloxone — free from needle exchanges', icon: '?' },
    { label: 'Self-refer', value: 'Frank: 0300 123 6600 (24/7, free)', icon: '??' },
  ],
  bodyParagraphs: [
    'Opioid addiction is one of the most serious and life-threatening forms of addiction. NHS treatment in [location] is free, highly effective, and available without needing a GP referral — you can self-refer by calling Frank on 0300 123 6600.',
    ...
    'Naloxone (Narcan) can reverse an opioid overdose in minutes and is available free from needle exchanges and pharmacies in [location] without a prescription. If you or someone you know uses opioids, please carry naloxone — it saves lives.',
  ],
  faqs: (location: string) => [
    { question: `What is the best treatment for opiate addiction?`, answer: `The most effective treatment combines medication-assisted treatment (MAT) — methadone or buprenorphine — with psychological support. Both medications eliminate withdrawal symptoms and cravings and dramatically reduce overdose risk. Long-term MAT is evidence-based, life-saving, and available free on the NHS in ${location}.` },
    { question: `Where can I get opiate addiction help in ${location}?`, answer: `NHS opioid treatment in ${location} is free and you can self-refer — call Frank on 0300 123 6600 (24/7). Treatment includes methadone or buprenorphine prescribing, keyworking, harm reduction, and access to residential rehab for those who need it.` },
    ...
    { question: `Is there stigma about methadone treatment?`, answer: `Unfortunately yes — but the evidence is clear: methadone and buprenorphine save lives. Opioid substitution therapy is not just swapping one drug for another — it provides a controlled dose that eliminates the need to use illicit heroin and all its risks. NHS services in ${location} treat all patients with dignity and respect.` },
    { question: `I'm addicted to prescription opioids, not heroin — can I still get help?`, answer: `Yes. NHS opioid treatment services in ${location} treat dependency on all opioids — codeine, tramadol, oxycodone, fentanyl patches, buprenorphine tablets, and any other opioid medication. Treatment is tailored to your specific situation.` },
  ],
  ctaLabel: 'Call Frank free: 0300 123 6600',
  ctaHref: 'tel:03001236600',
  secondaryCta: { label: 'Heroin help in [Location]', href: '/heroin-addiction/[location]' },
...
export const ALCOHOL_DETOX_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Alcohol detox in [location] is the medically supervised process of safely withdrawing from alcohol. If you drink heavily every day and have physical dependency symptoms (shakes, sweats, anxiety when not drinking), detox MUST be medically supervised — unsupervised alcohol withdrawal can cause fatal seizures. Free NHS alcohol detox is available in [location] via self-referral. Call Frank on 0300 123 6600 (free, 24/7).',
  keyFacts: [
    { label: 'NHS detox', value: 'Free — home or residential', icon: '??' },
    { label: 'Medication', value: 'Chlordiazepoxide (Librium)', icon: '??' },
    { label: 'Duration', value: '7–10 days typically', icon: '??' },
  ...
  bodyParagraphs: [
    ...
    'After completing alcohol detox in [location], the physical dependency is broken — but psychological rehabilitation is essential to prevent relapse. All NHS detox pathways in [location] include referral to ongoing community alcohol treatment, counselling, and relapse prevention support. Detox alone without rehab has relapse rates of up to 80% within a year.',
  ],
  faqs: (location: string) => [
    { question: `Do I need alcohol detox in ${location}?`, answer: `You need medically supervised detox if you: drink daily, experience shakes/sweats/anxiety when you stop, have had previous withdrawal seizures, or feel physically unwell when you don't drink. Never try to stop cold turkey if physically dependent — call Frank (0300 123 6600) or your GP first.` },
    { question: `Is alcohol detox free in ${location}?`, answer: `Yes. NHS community alcohol detox in ${location} — including all medication — is completely free. Self-refer via Frank (0300 123 6600) or your GP. Private residential detox near ${location} typically costs £1,500–£4,000.` },
    { question: `How long does alcohol detox take?`, answer: `Medically supervised alcohol detox typically takes 7–10 days with a reducing dose of chlordiazepoxide. The most dangerous phase (seizure risk) is 24–48 hours after the last drink. After 7–10 days, the physical dependency is broken.` },
    ...
    { question: `Can I detox from alcohol at home in ${location}?`, answer: `Community alcohol detox — where you remain at home while a clinical team supervises you daily and provides medication — is available free from NHS services in ${location}. This is different from trying to stop drinking alone at home without support, which is dangerous.` },
  ],
  ctaLabel: 'Call Frank free: 0300 123 6600',
  ctaHref: 'tel:03001236600',
  secondaryCta: { label: 'Alcohol rehab in [Location]', href: '/alcohol-rehab/[location]' },
...
export const DRUG_DETOX_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Drug detox in [location] is the medically supervised process of safely withdrawing from addictive substances — including heroin, prescription opioids, benzodiazepines, and other drugs. Free NHS drug detox is available in [location] through self-referral. Opioid detox uses medication such as buprenorphine or lofexidine. Benzo detox requires a supervised reducing dose. Call Frank on 0300 123 6600 (free, 24/7) to find the right drug detox option in [location].',
  keyFacts: [
    { label: 'NHS drug detox', value: 'Free — self-refer via Frank', icon: '??' },
    { label: 'Opioid detox meds', value: 'Buprenorphine, lofexidine', icon: '??' },
    { label: 'Benzo detox', value: 'Reducing diazepam — very gradual', icon: '??' },
    { label: 'Duration', value: 'Varies by substance — days to weeks', icon: '??' },
  ],
  bodyParagraphs: [
  ...
  faqs: (location: string) => [
    { question: `Is drug detox free in ${location}?`, answer: `Yes. NHS drug detox in ${location} is completely free. This includes assessment, medication, and clinical supervision. Call Frank (0300 123 6600) or your GP to self-refer. Private drug detox near ${location} typically costs £2,000–£6,000.` },
    ...
    { question: `How long does drug detox take in ${location}?`, answer: `Duration varies by substance: heroin detox 7–14 days; short-term benzo detox weeks to months (depending on dose and duration of use); alcohol detox 7–10 days; cocaine/cannabis withdrawal is primarily psychological with no fixed detox duration. Your clinical team in ${location} will create an individualised plan.` },
    { question: `What is the difference between drug detox and drug rehab?`, answer: `Detox addresses the physical withdrawal phase — removing the drug from your body safely with medication. Rehab addresses the psychological, behavioural, and social aspects of addiction that follow. Detox is usually the first phase of a broader treatment programme. Most people who detox without also completing rehab relapse within months.` },
    { question: `Can I detox from drugs at home in ${location}?`, answer: `Community drug detox — at home with daily clinical supervision and medication — is available free through NHS services in ${location} for appropriate candidates. Whether home or residential detox is safer depends on your substance, dependency severity, home situation, and medical history. Your clinical team will advise.` },
...
export const RESIDENTIAL_REHAB_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Residential rehab in [location] provides intensive, live-in addiction treatment where you stay at the facility for the duration of your programme — typically 28, 60, or 90 days. Residential rehab removes you from your usual environment and triggers, offering round-the-clock support, medically supervised detox if needed, daily therapy, and structured recovery activities. NHS-funded residential rehab is available for those assessed as needing it. Private residential rehab near [location] offers faster admission — often within days.',
  keyFacts: [
    { label: 'NHS-funded', value: 'Free if assessed and approved', icon: '??' },
    { label: 'Private 28-day', value: '£3,000–£12,000 all-inclusive', icon: '??' },
    { label: 'Programme length', value: '28, 60, or 90 days', icon: '??' },
    { label: 'Includes', value: 'Detox, therapy, group work, meals, accommodation', icon: '??' },
  ],
  bodyParagraphs: [
    'Residential rehab in [location] is the most intensive form of addiction treatment. Living at the facility means you are removed from the people, places, and patterns that trigger your use — creating the space for real change. A typical residential programme includes medically supervised detox (if physically dependent), individual therapy, group therapy, 12-step or SMART Recovery work, family sessions, and relapse prevention planning.',
    'NHS-funded residential rehab is available in [location] for those who have been assessed by a drug and alcohol team as requiring this level of intervention. The assessment process can take time — private residential rehab near [location] offers the same quality of care with immediate to same-week admission. Research consistently shows that 60–90 day residential programmes produce significantly better long-term outcomes than shorter programmes.',
  ],
  faqs: (location: string) => [
    ...
    { question: `What is the success rate of residential rehab?`, answer: `Residential rehab produces better outcomes than community treatment alone, with 60–90 day programmes showing the highest completion and sobriety rates. Studies show around 30–50% of people completing residential rehab maintain abstinence at 1 year. Quality of aftercare is the single biggest predictor of long-term outcome after residential treatment.` },
  ],
  ctaLabel: 'Call Frank free: 0300 123 6600',
  ctaHref: 'tel:03001236600',
  secondaryCta: { label: 'Private rehab in [Location]', href: '/private-rehab/[location]' },
...
export const OUTPATIENT_REHAB_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Outpatient rehab in [location] provides structured addiction treatment while you continue to live at home — attending therapy sessions, group work, and clinical appointments without the need for residential admission. NHS community treatment in [location] is outpatient-based and completely free. Outpatient rehab suits those with a supportive home environment, milder dependency, work or caring responsibilities, or those transitioning from residential treatment.',
  keyFacts: [
    { label: 'NHS outpatient', value: 'Free — self-refer via Frank', icon: '??' },
    { label: 'Frequency', value: '1–5 sessions per week depending on intensity', icon: '??' },
    { label: 'IOP', value: 'Intensive outpatient: 3–5 days/week', icon: '??' },
    { label: 'Best for', value: 'Supportive home, mild-moderate dependency', icon: '??' },
  ],
  bodyParagraphs: [
    'Outpatient rehab in [location] ranges from standard community treatment (1–2 appointments per week) to intensive outpatient programmes (IOP) involving 3–5 days per week of structured therapy. NHS drug and alcohol services in [location] deliver community outpatient treatment free of charge, including keyworking, medication, CBT, group therapy, and harm reduction support.',
  ...
  faqs: (location: string) => [
    { question: `What is outpatient rehab?`, answer: `Outpatient rehab means receiving addiction treatment while living at home — attending sessions at a clinic, community centre, or NHS drug and alcohol service on a scheduled basis. This contrasts with residential (inpatient) rehab where you live at the treatment centre. Outpatient rehab can be as intensive as 5 days per week (IOP) or as light as a weekly keyworker appointment.` },
    { question: `Is outpatient rehab free in ${location}?`, answer: `Yes. NHS community drug and alcohol treatment in ${location} — which is outpatient-based — is completely free. This includes keyworking, medication, CBT, group therapy, and harm reduction. Call Frank (0300 123 6600) or your GP to self-refer to NHS outpatient services in ${location}.` },
    ...
    { question: `What is an Intensive Outpatient Programme (IOP)?`, answer: `An IOP is a structured outpatient programme typically running 3–5 days per week, providing a higher intensity of treatment than standard community appointments while allowing you to remain at home. IOPs are available through some NHS services and many private providers in ${location}.` },
...
export const HEROIN_DETOX_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Heroin detox in [location] is the medically supervised process of withdrawing safely from heroin and other opioids. While heroin withdrawal is rarely directly fatal (unlike alcohol), it is severely uncomfortable and almost always leads to relapse without medical support. Free NHS heroin detox is available in [location] — including buprenorphine-assisted detox and lofexidine. Call Frank on 0300 123 6600 (free, 24/7) to access heroin detox services in [location] today.',
  keyFacts: [
    { label: 'Free NHS detox', value: 'Buprenorphine or lofexidine', icon: '??' },
    { label: 'Starts', value: '6–24 hours after last heroin use', icon: '??' },
    { label: 'Peak withdrawal', value: '36–72 hours', icon: '??' },
    { label: 'Duration', value: '7–14 days for acute withdrawal', icon: '??' },
  ],
  bodyParagraphs: [
    'Heroin withdrawal in [location] typically begins 6–24 hours after the last use and peaks at 36–72 hours. Symptoms include severe muscle cramps, nausea and vomiting, sweating, insomnia, anxiety, and intense cravings. While rarely directly fatal, untreated heroin withdrawal is so severely uncomfortable that it almost universally leads to relapse — usually at a lower tolerance level, dramatically increasing overdose risk.',
  ...
  faqs: (location: string) => [
    ...
    { question: `What medication is used in heroin detox?`, answer: `The main medications used in heroin detox are: buprenorphine (Subutex) — a partial opioid agonist that reduces withdrawal symptoms significantly; lofexidine — reduces autonomic withdrawal symptoms like sweating and cramps without opioid effects; and methadone on a reducing dose. Your clinical team will advise which is most appropriate.` },
...
export const ALCOHOL_COUNSELLING_CONFIG: RehabTypeConfig = {
  ...
  faqs: (location: string) => [
    ...
    { question: `How many sessions of alcohol counselling will I need?`, answer: `This varies significantly. Brief alcohol intervention (3–6 sessions) is effective for hazardous drinkers. CBT for alcohol use disorder typically runs 12–20 sessions. Longer-term psychotherapy for complex cases (trauma history, dual diagnosis) may continue for months or years. Your counsellor in ${location} will discuss an appropriate treatment plan at assessment.` },
    { question: `Can alcohol counselling help if I don't want to stop drinking completely?`, answer: `Yes. Alcohol counsellors in ${location} work with a range of goals — moderation, reduction, harm minimisation, and abstinence. Motivational interviewing is specifically designed to explore ambivalence without pressuring a particular outcome. Whether your goal is to reduce, moderate, or stop, counselling can help.` },
    { question: `Can I have alcohol counselling online?`, answer: `Yes. Online alcohol counselling (via video call) is increasingly available in ${location} through both NHS services and private counsellors. Many people find online counselling more accessible — particularly for those with work commitments, mobility issues, or where there are limited face-to-face options locally.` },
  ],
...
export const DRUG_COUNSELLING_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Drug counselling in [location] provides one-to-one psychological support for people affected by drug addiction — from cannabis and cocaine through to heroin and prescription drugs. Free drug counselling is available through NHS drug and alcohol services in [location] by self-referral. Sessions use evidence-based approaches including CBT, motivational interviewing, and trauma-informed therapy. Call Frank on 0300 123 6600 to access free drug counselling in [location] today.',
  keyFacts: [
    { label: 'Free NHS', value: 'Self-refer via Frank 0300 123 6600', icon: '??' },
    { label: 'CBT', value: 'Cognitive Behavioural Therapy — evidence-based', icon: '??' },
    { label: 'Private cost', value: '£50–£120 per session', icon: '??' },
    { label: 'Covers', value: 'All substances — legal and illegal', icon: '??' },
  ],
  bodyParagraphs: [
    ...
    'NHS drug counselling in [location] is delivered as part of structured community drug treatment — usually alongside keyworking, medication if appropriate, and group support. Self-referral is available by calling Frank (0300 123 6600) or through your GP. Private drug counsellors — available independently of NHS services — typically specialise in addiction and offer more flexible appointment times.',
  ],
  faqs: (location: string) => [
    { question: `Is drug counselling free in ${location}?`, answer: `Yes. NHS drug treatment services in ${location} provide free drug counselling as part of community treatment. This includes one-to-one keyworking, CBT, motivational interviewing, and group therapy. Call Frank (0300 123 6600) to self-refer. Private drug counselling costs £50–£120 per session.` },
    { question: `What types of drug counselling are available in ${location}?`, answer: `Available approaches include: Cognitive Behavioural Therapy (CBT) — identifying and changing patterns that lead to use; Motivational Interviewing (MI) — building internal motivation for change; EMDR — for trauma underlying drug use; 12-step facilitation — supporting engagement with NA and other mutual aid; Contingency Management — positive reinforcement for abstinence.` },
    ...
    { question: `How long does drug counselling take?`, answer: `CBT for drug addiction typically involves 12–20 structured weekly sessions. Brief interventions are 3–6 sessions. Complex cases with multiple substances or significant trauma history may benefit from longer-term therapy. NHS services offer time-limited interventions — private practitioners can offer longer-term work.` },
    { question: `I use cocaine — can I get counselling in ${location}?`, answer: `Yes. Drug counselling in ${location} covers all substances including cocaine, crack cocaine, MDMA, cannabis, ketamine, and all prescription drugs. There is no substance that disqualifies you from accessing counselling support. Cocaine Anonymous (CA) groups also provide peer support specifically for cocaine and crack users in ${location}.` },
  ],
  ctaLabel: 'Call Frank free: 0300 123 6600',
  ctaHref: 'tel:03001236600',
  secondaryCta: { label: 'Drug rehab in [Location]', href: '/drug-rehab/[location]' },
...
export const ANTIDEPRESSANT_ADDICTION_CONFIG: RehabTypeConfig = {
  ...
  keyFacts: [
    { label: 'Not addiction', value: 'Physical dependency — different from addiction', icon: '??' },
    { label: 'Discontinuation', value: 'Symptoms: dizziness, nausea, electric shocks', icon: '?' },
    { label: 'Safe tapering', value: 'Very slow dose reduction — weeks to months', icon: '??' },
  ...
  faqs: (location: string) => [
    ...
    { question: `Can I get therapy to help come off antidepressants?`, answer: `Yes. Psychological therapies — particularly CBT — can help address the underlying depression or anxiety that antidepressants were prescribed for, making it easier to reduce them safely. Ask your GP for a referral to IAPT (Improving Access to Psychological Therapies) services in ${location}, or access private CBT therapy.` },
    { question: `How long does antidepressant withdrawal last?`, answer: `For most antidepressants, discontinuation symptoms resolve within 1–4 weeks. However, for paroxetine (Seroxat) and venlafaxine, symptoms can persist for months in some individuals. Very slow tapering (using liquid formulations) significantly reduces the severity and duration of discontinuation symptoms.` },
  ],
...
export const INHALANT_ADDICTION_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Inhalant and solvent addiction (volatile substance abuse, VSA) involves sniffing, huffing, or bagging volatile substances such as glue, butane lighter fluid, aerosols, petrol, and correction fluid. VSA is most common among young people but affects all ages. Sudden Sniffing Death Syndrome (SSDS) can cause fatal cardiac arrest on first use — VSA is extremely dangerous. Free support is available in [location] via Frank (0300 123 6600) and specialist drug services.',
  keyFacts: [
    { label: 'Risk', value: 'Sudden Sniffing Death Syndrome — first use can kill', icon: '??' },
    ...
    { label: 'Frank (free)', value: '0300 123 6600 — 24/7 confidential', icon: '??' },
  ],
  bodyParagraphs: [
  ...
  faqs: (location: string) => [
    ...
    { question: `My child is sniffing solvents — what should I do?`, answer: `Stay calm and do not react with anger, which can drive the behaviour underground. Express concern from a place of care. Remove obvious inhalants from the home (aerosols, lighter fluid). Contact Frank (0300 123 6600) for specific advice for parents. Your GP can refer to CAMHS or young people's drug services in ${location}. Do not leave a young person alone if you suspect recent VSA use — cardiac risk is highest in the moments after inhaling.` },
...
export const AMPHETAMINE_ADDICTION_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Amphetamine (speed) addiction is a stimulant dependency affecting thousands of UK adults. Amphetamine use causes intense euphoria, insomnia, paranoia, and cardiovascular strain — and regular use leads rapidly to psychological dependency and psychosis. Free NHS treatment for amphetamine addiction is available in [location] through self-referral. Call Frank on 0300 123 6600 (free, 24/7).',
  keyFacts: [
    { label: 'Street names', value: 'Speed, Billy, Whizz, Sulphate', icon: '??' },
    { label: 'Form', value: 'Powder, paste, tablets, capsules', icon: '??' },
    { label: 'Addiction type', value: 'Psychological dependency — no physical detox needed', icon: '??' },
  ...
  faqs: (location: string) => [
    ...
    { question: `What are amphetamine withdrawal symptoms?`, answer: `Unlike heroin or alcohol, amphetamine does not cause dangerous physical withdrawal. However, psychological withdrawal can be severe: extreme fatigue and hypersomnia (sleeping for very long periods), intense depression, irritability, increased appetite, strong cravings, and cognitive impairment. Withdrawal symptoms peak at 2–4 days and resolve over 1–2 weeks, though depression and anhedonia can persist for months.` },
...
export const MDMA_ADDICTION_CONFIG: RehabTypeConfig = {
  ...
  intro: 'MDMA (ecstasy, MD, pills) addiction affects thousands of UK adults — particularly those in music festival and nightclub cultures. While MDMA is less addictive than heroin or crack, psychological dependency, compulsive use, and severe mental health consequences are common with regular use. Free support for MDMA addiction is available in [location] through NHS drug services. Call Frank on 0300 123 6600 (free, 24/7).',
  keyFacts: [
    ...
    { label: 'Mental health', value: 'Depression, anxiety, psychosis — including after stopping', icon: '??' },
...
export const PAINKILLER_ADDICTION_CONFIG: RehabTypeConfig = {
  ...
  keyFacts: [
    ...
    { label: 'NHS treatment', value: 'Free — including detox and prescribing', icon: '??' },
  ...
  faqs: (location: string) => [
    ...
    { question: `Is painkiller addiction treated differently from heroin addiction?`, answer: `The treatment is essentially the same, because the drugs work on the same opioid receptors. NHS opioid treatment services in ${location} treat dependency on all opioids — prescribed codeine, tramadol, and oxycodone are treated identically to heroin dependency. Buprenorphine or methadone maintenance, supervised tapering, and CBT are all evidence-based options.` },
    { question: `Can I get NHS help for codeine or tramadol addiction in ${location}?`, answer: `Yes. NHS drug treatment services in ${location} treat dependency on all opioids including codeine, co-codamol, Nurofen Plus, tramadol, oxycodone, and morphine. Treatment is free and confidential. Self-refer by calling Frank (0300 123 6600) — you do not need a GP referral, though involving your GP is also recommended.` },
    { question: `How do I safely stop taking painkillers?`, answer: `Never stop opioid painkillers suddenly if you have been taking them regularly for more than a few weeks — the withdrawal is medically manageable with support but very unpleasant without it. NHS services in ${location} can prescribe a supervised reducing dose or buprenorphine to manage withdrawal safely. Call Frank (0300 123 6600) or your GP to begin the process.` },
    { question: `I buy codeine products over the counter — do I have a problem?`, answer: `If you regularly buy codeine-containing OTC products (co-codamol, Nurofen Plus, Solpadeine Max) from pharmacies and are taking them beyond the recommended dose or duration, you may have developed physical dependency. This is very common and not a moral failing. NHS services treat OTC codeine dependency exactly as other opioid dependency — help is free and confidential.` },
    { question: `Does painkiller addiction affect chronic pain?`, answer: `Often yes — this is one of the most complex aspects of painkiller dependency. Opioids can actually worsen pain sensitivity over time (opioid-induced hyperalgesia). NHS pain services and drug treatment services in ${location} work together to address both chronic pain management and opioid dependency. There are effective non-opioid approaches to chronic pain that can be explored.` },
  ],
  ctaLabel: 'Call Frank free: 0300 123 6600',
  ctaHref: 'tel:03001236600',
...
export const SLEEPING_PILL_ADDICTION_CONFIG: RehabTypeConfig = {
  ...
  keyFacts: [
    ...
    { label: 'Dependency', value: 'Can develop within 2–4 weeks', icon: '?' },
    { label: 'Withdrawal risk', value: 'Seizures — never stop suddenly', icon: '??' },
  ...
  faqs: (location: string) => [
    ...
    { question: `How do I safely come off sleeping pills in ${location}?`, answer: `Speak to your GP in ${location} about a supervised tapering plan. This typically involves converting your current sleeping pill to an equivalent dose of diazepam (which has a longer half-life and is easier to taper), then reducing by 10% of the current dose every 2–4 weeks. The process can take 6–12 months for long-term users. NHS prescribing services can support this.` },
    { question: `What is CBT-I and does it work for insomnia?`, answer: `Cognitive Behavioural Therapy for Insomnia (CBT-I) is consistently the most effective long-term treatment for insomnia — outperforming sleeping pills in head-to-head trials. It involves sleep restriction therapy, stimulus control, relaxation techniques, and challenging anxious thoughts about sleep. Ask your GP for a referral in ${location}, or access self-guided CBT-I through the NHS Sleepio app (free via some NHS trusts).` },
    { question: `I've been prescribed zopiclone for years — what are my options?`, answer: `Long-term zopiclone use is now considered inappropriate prescribing under NICE guidance (you should not take zopiclone for more than 4 weeks). Your GP in ${location} should be working with you to reduce and stop it with a slow taper. If they are not providing support for this, ask specifically for a referral to a specialist prescribing service or addiction service.` },
    { question: `Will my insomnia return when I stop sleeping pills?`, answer: `Rebound insomnia is very common when stopping sleeping pills — the first 2–4 weeks after stopping typically involve worse sleep than before you started. This is temporary. With CBT-I support and sleep hygiene improvements, most people's sleep normalises within weeks to months. Many people sleep better in the long term without sleeping pills than they did on them.` },
  ],
  ctaLabel: 'Call Frank free: 0300 123 6600',
  ctaHref: 'tel:03001236600',
...
export const WOMENS_REHAB_CONFIG: RehabTypeConfig = {
  ...
  faqs: (location: string) => [
    ...
    { question: `Do women experience addiction differently?`, answer: `Yes. Women often develop dependency faster (telescoping), are more likely to have co-occurring conditions such as depression, anxiety, eating disorders, and PTSD, are more likely to have experienced domestic violence or sexual trauma driving their use, and face greater social stigma — particularly as mothers — which is a significant barrier to help-seeking.` },
    ...
    { question: `Is it harder for women to get addiction treatment?`, answer: `Historically yes — women face greater stigma, are more likely to have childcare responsibilities preventing treatment access, and were historically underrepresented in addiction treatment research. NHS services in ${location} now have specific guidance on gender-responsive treatment and should be able to accommodate the specific needs of women. Use Frank (0300 123 6600) to navigate services.` },
    { question: `What therapies are used in women's rehab?`, answer: `Women's rehab programmes typically offer: trauma-informed CBT, EMDR (for PTSD and trauma), DBT (Dialectical Behaviour Therapy — particularly effective for emotional regulation in women with complex trauma), relapse prevention, 12-step or SMART Recovery, body image and eating disorder work, domestic abuse safety planning, and parenting support.` },
    { question: `My drinking increased after domestic abuse — is there specialist help?`, answer: `Yes. Many women's addiction services in ${location} work closely with domestic abuse services and provide integrated support for both. The relationship between domestic abuse and substance use is well recognised — some women drink or use drugs to cope with ongoing abuse, others to manage the PTSD aftermath. Specialist services can address both simultaneously.` },
  ],
  ctaLabel: 'Call Frank: 0300 123 6600',
  ctaHref: 'tel:03001236600',
  secondaryCta: { label: 'Residential rehab in [Location]', href: '/residential-rehab/[location]' },
...
export const TEEN_ADDICTION_CONFIG: RehabTypeConfig = {
  ...
  faqs: (location: string) => [
    ...
    { question: `My child is 15 and drinking every weekend — is this an addiction?`, answer: `Regular weekend drinking or drug use at 15 is a significant concern even if it doesn\'t meet strict addiction criteria. The adolescent brain is particularly vulnerable to harm from alcohol — even moderate amounts have more impact than on adult brains. Early intervention is much more effective than waiting. Young people\'s services in ${location} are skilled at working with exploratory and harmful use as well as dependency.` },
    { question: `Does addiction treatment for young people involve residential rehab?`, answer: `Residential addiction treatment for under-18s is rare and only used for very severe cases. The vast majority of young people\'s treatment in ${location} is community-based — outpatient keyworking, family therapy, school liaison, and group work. Residential options for young people do exist and are fully NHS-funded where clinically indicated.` },
  ],
  ctaLabel: 'Call Frank: 0300 123 6600',
  ctaHref: 'tel:03001236600',
  secondaryCta: { label: 'Drug treatment in [Location]', href: '/drug-treatment/[location]' },
...
export const WORKPLACE_ADDICTION_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Workplace addiction affects an estimated 1 in 5 UK employees. Alcohol and drug problems cost UK employers an estimated £7.3 billion per year in lost productivity, sickness absence, and accidents. Free and confidential addiction support is available to employees in [location] through NHS services, EAPs (Employee Assistance Programmes), and occupational health. Employers in [location] have both a duty of care and a legal framework for managing substance misuse at work.',
  keyFacts: [
    { label: 'EAP', value: 'Employee Assistance Programme — usually free & confidential', icon: '??' },
    ...
    { label: 'NHS', value: 'Free treatment — you don\'t need to tell your employer', icon: '??' },
  ],
  bodyParagraphs: [
    'If your alcohol or drug use is affecting your work in [location], you have several options that do not require telling your employer. NHS drug and alcohol services in [location] are completely confidential — your employer has no right to know. Many employees access their employer\'s EAP (Employee Assistance Programme) for free, confidential up to 6 sessions of counselling and referral support. EAP access details are usually in your employment contract or HR intranet.',
...
export const AFTERCARE_CONFIG: RehabTypeConfig = {
  ...
  bodyParagraphs: [
    ...
    'NHS outpatient services in [location] automatically provide a period of aftercare following residential treatment. If you are leaving private rehab, ensuring a good aftercare plan is in place before discharge is essential — ask your rehab centre to coordinate handover to NHS community services in [location]. Most reputable private rehab centres offer ongoing telephone or video aftercare sessions as part of their programme.',
  ],
  faqs: (location: string) => [
    ...
    { question: `How long should aftercare last after rehab?`, answer: `Minimum 12 months of structured aftercare is recommended for most people following rehab. Recovery is longest in the first year — most relapses occur in the first 90 days after discharge. Many people continue some form of aftercare support (AA, counselling, medication) for years or indefinitely, which significantly protects long-term recovery.` },
    { question: `Is aftercare free in ${location}?`, answer: `Yes. NHS community aftercare in ${location} is free following completion of either NHS or private rehab. This includes ongoing keyworking, counselling, medication review, and care coordination. AA and NA meetings in ${location} are always free. SMART Recovery meetings are free. Private aftercare counselling costs £50–£120/session.` },
    { question: `What if I relapse after rehab?`, answer: `Relapse is common and should be met with compassion, not shame. Relapse does not erase the progress made in rehab — it is a data point about what additional support is needed. Contact your keyworker or call Frank (0300 123 6600) immediately if you relapse. Early re-engagement with treatment after relapse produces much better outcomes than waiting.` },
    { question: `My aftercare plan from my rehab is minimal — what can I do?`, answer: `Self-refer to NHS drug and alcohol services in ${location} (call Frank: 0300 123 6600) and request a comprehensive aftercare package. Attend local AA, NA, or SMART Recovery meetings — these are free and available every week. Consider private counselling if financially possible. Contact your rehab centre if they offer ongoing telephone aftercare support.` },
    { question: `What is HALT and why does it matter in aftercare?`, answer: `HALT stands for Hungry, Angry, Lonely, Tired — the four states that most commonly trigger relapse. Relapse prevention planning in ${location} focuses on recognising HALT states early and having concrete strategies for each. Simple self-monitoring against HALT daily is one of the most effective relapse prevention tools.` },
  ],
  ctaLabel: 'Call Frank: 0300 123 6600',
  ctaHref: 'tel:03001236600',
  secondaryCta: { label: 'Residential rehab in [Location]', href: '/residential-rehab/[location]' },
...
export const HARM_REDUCTION_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Harm reduction services in [location] help people who use drugs to stay safer while they continue using — reducing the risk of overdose, blood-borne viruses, and other serious harms. Services include needle and syringe exchange, free naloxone, drug checking, safer use advice, vaccinations (Hepatitis B), HIV testing, and outreach. Harm reduction is a core component of the UK drug strategy and is available free across [location] without judgement and without requiring abstinence.',
  keyFacts: [
    { label: 'Needle exchange', value: 'Free sterile equipment — no registration required', icon: '??' },
    { label: 'Naloxone', value: 'Free overdose reversal — from exchanges and pharmacies', icon: '?' },
  ...
  bodyParagraphs: [
    'Harm reduction services in [location] operate on the principle that reducing drug-related harm is a legitimate goal in itself — not a compromise or a consolation prize for failing to achieve abstinence. Needle and syringe programmes dramatically reduce HIV and Hepatitis C transmission. Take-Home Naloxone programmes save lives by putting overdose reversal medication directly in the hands of people most at risk. Drug checking services (where available) prevent deaths from unknowingly contaminanted substances.',
  ...
  faqs: (location: string) => [
    ...
    { question: `What is drug checking and where is it available?`, answer: `Drug checking services allow people to have substances tested for dangerous adulterants — including fentanyl, nitazenes, and other contaminants. Drug checking is available at some UK festivals and harm reduction services, though provision in ${location} varies. The Loop provides festival drug checking. Some NHS services offer point-of-care drug testing.` },
...
export const OPIOID_SUBSTITUTION_CONFIG: RehabTypeConfig = {
  ...
  faqs: (location: string) => [
    ...
    { question: `Will being on methadone affect my employment or driving?`, answer: `Being on a stable dose of methadone or buprenorphine does not automatically disqualify you from working. For driving, DVLA guidance states that stable, prescribed opioid substitution therapy does not automatically revoke your licence — your GP or prescriber can provide supporting documentation. This is assessed on a case-by-case basis.` },
    { question: `Is OST a long-term treatment or can I stop?`, answer: `Research shows that long-term OST (years rather than months) produces the best outcomes. Stopping OST increases mortality risk significantly. Some people do successfully taper and stop over time — this should be done very gradually under medical supervision. The decision to reduce and stop should be led by the patient in partnership with their clinical team in ${location}.` },
    { question: `Is stigma around methadone a problem?`, answer: `Unfortunately, yes. People on methadone often face stigma in healthcare settings, from families, and from employers. This stigma is harmful and evidence-free. Methadone therapy saves lives. NHS services in ${location} should treat OST patients with the same respect as any other patient managing a long-term condition — if you experience stigmatising treatment, you have the right to complain and request a different prescriber.` },
  ],
  ctaLabel: 'Call Frank free: 0300 123 6600',
  ctaHref: 'tel:03001236600',
  secondaryCta: { label: 'Heroin addiction help in [Location]', href: '/heroin-addiction/[location]' },
...
export const ONLINE_REHAB_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Online rehab and remote addiction treatment in [location] provides structured therapy, group support, and clinical management via video call, app, or telephone — without needing to attend a facility in person. Remote addiction treatment has grown significantly since 2020 and produces outcomes comparable to face-to-face work for many people. NHS drug and alcohol services in [location] now routinely offer telephone and video appointments. Private online rehab is also available.',
  keyFacts: [
  ...
  faqs: (location: string) => [
    ...
    { question: `Can I get online addiction treatment through the NHS in ${location}?`, answer: `Yes. NHS drug and alcohol services in ${location} offer telephone and video appointments for keyworking, counselling, and prescribing reviews. The availability of remote options varies by service — ask specifically when you contact them. Self-refer via Frank (0300 123 6600).` },
    { question: `What does private online rehab include?`, answer: `Private online rehab programmes typically include: initial assessment via video, individual therapy sessions (CBT, motivational interviewing), group therapy sessions (live, via video), digital peer support community, relapse prevention planning, and some programmes include medication management. Duration ranges from 4–12 weeks for structured programmes.` },
...
export const RECOVERY_COACHING_CONFIG: RehabTypeConfig = {
  ...
  intro: 'Recovery coaching in [location] provides practical, lived-experience-based support for people in early recovery from addiction. Unlike clinical treatment, recovery coaches are typically people in long-term recovery themselves — offering mentoring, practical life skills, accountability, and peer connection. Recovery coaching complements clinical treatment and is increasingly available through NHS services, charities, and private providers in [location].',
  keyFacts: [
    { label: 'Lived experience', value: 'Coaches are typically in long-term recovery', icon: '??' },
    { label: 'Complements', value: 'Works alongside clinical treatment — not instead of', icon: '??' },
  ...
  faqs: (location: string) => [
    ...
    { question: `How do I find a recovery coach in ${location}?`, answer: `Contact local drug and alcohol charities in ${location} — many employ peer support workers with lived experience. SMART Recovery UK lists peer mentors. The Association for Coaching and UKCP maintain directories of accredited private coaches. Some NHS services in ${location} now embed peer support workers as part of their team.` },
    { question: `Does my recovery coach need to be sober?`, answer: `Recovery coaches are typically in sustained long-term recovery themselves — this lived experience is what makes the relationship distinctive. Most recovery coaching programmes require coaches to have a minimum period of sustained recovery (typically 2+ years). This is not a rule about worth — it is about the coach having had time to develop stable recovery practices to share.` },
...
export const NON_12_STEP_CONFIG: RehabTypeConfig = {
  ...
  bodyParagraphs: [
    ...
    'The good news is that most NHS drug and alcohol treatment in [location] is already not 12-step based — it uses NICE-approved evidence-based approaches. For those leaving residential rehab who do not want AA or NA, SMART Recovery offers free, secular, evidence-based group support with meetings across [location] and online. Some private rehab centres in [location] specifically offer non-12-step programmes using CBT and mindfulness frameworks.',
  ],
  faqs: (location: string) => [
    ...
    { question: `I tried AA and it didn\'t work for me — what else can I try?`, answer: `Not working with AA does not mean recovery is impossible — it means AA\'s specific approach wasn\'t the right fit. SMART Recovery is the most widely available secular alternative and has strong evidence behind it. Individual CBT therapy is highly effective. Ask your keyworker or GP in ${location} about SMART Recovery referral or evidence-based alternatives to mutual aid.` },
  ],
  ctaLabel: 'Call Frank: 0300 123 6600',
  ctaHref: 'tel:03001236600',
  secondaryCta: { label: 'Outpatient rehab in [Location]', href: '/outpatient-rehab/[location]' },
...
export const FAMILY_THERAPY_CONFIG: RehabTypeConfig = {
  ...
  faqs: (location: string) => [
    ...
    { question: `Is Behavioural Couples Therapy effective for addiction?`, answer: `Yes — Behavioural Couples Therapy (BCT) is the most evidence-based couples intervention for addiction. Research shows BCT significantly outperforms individual therapy for both addiction outcomes and relationship satisfaction. Both partners attend together and work on communication, relationship skills, and a sobriety contract. Ask your NHS service or a private therapist in ${location} about BCT.` },
    ...
    { question: `What is codependency and how does it relate to family therapy?`, answer: `Codependency describes a pattern where a family member\'s emotional wellbeing becomes excessively focused on the person with addiction — managing their crises, covering up consequences, and neglecting their own needs. While controversial as a clinical term, the pattern it describes is real and common. Family therapy in ${location} addresses these dynamics in a non-blaming way.` },
  ],
  ctaLabel: 'Call Frank: 0300 123 6600',
  ctaHref: 'tel:03001236600',
  secondaryCta: { label: 'Al-Anon meetings in [Location]', href: '/al-anon/[location]' },
...
export const ABSTINENCE_REHAB_CONFIG: RehabTypeConfig = {
  ...
  keyFacts: [
    { label: 'Definition', value: 'Complete abstinence — no alcohol or drugs', icon: '??' },
    { label: '12-step', value: 'AA, NA, CA — all abstinence-based', icon: '??' },
