...
import { WORKPLACE_ADDICTION_CONFIG } from '../../../lib/rehab-types'
...
export default async function Page(
  ...
  const loc = getLocation(location)
  if (!loc) notFound()
  return <RehabTypePage config={WORKPLACE_ADDICTION_CONFIG} location={loc.name} locationSlug={location} loc={loc} />
}