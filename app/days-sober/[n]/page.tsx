...
export async function generateStaticParams() {
  return Array.from({ length: MAX_DAYS }, (_, i) => ({ n: String(i + 1) }))
}
    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <nav style={{ borderBottom: '1px solid var(--border)', background: 'var(--white)', position: 'sticky', top: 0, zIndex: 100 }}>
        <div className="container-wide" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 56 }}>
          ...
          <a href="/sobriety-counter" style={{ fontSize: 13, background: 'var(--accent)', color: '#fff', padding: '7px 14px', borderRadius: 'var(--radius-sm)', fontWeight: 600, textDecoration: 'none' }}>
