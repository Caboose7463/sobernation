...
import { RECOVERY_COACHING_CONFIG } from '../../../lib/rehab-types'
...
export default async function Page(
  ...
  const loc = getLocation(location)
  if (!loc) notFound()
  return <RehabTypePage config={RECOVERY_COACHING_CONFIG} location={loc.name} locationSlug={location} loc={loc} />
}