...
import {
  IconBuilding, IconPill, IconUsers, IconHeart,
...
export const metadata: Metadata = {
  title: 'Find Drug & Alcohol Rehab Near You | UK Addiction Recovery',
  description: "The UK's addiction recovery hub — find NHS and private rehab centres, AA & NA meetings, drug treatment services and free support across 3,800+ UK locations. Free to use.",
  openGraph: {
    title: 'Find Drug & Alcohol Rehab Near You | SoberNation',
    description: "The UK's addiction recovery hub — find rehab centres, drug treatment, AA & NA meetings and free support across the UK.",
  },
}
